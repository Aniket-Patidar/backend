...
exports.ValidateOrder = exports.order = exports.updateOrder = exports.getOrderById = exports.getAllOrders = exports.createOrder = void 0;
...
const generateBill = (user, _id, shippingAddress, TodayDate, totalPrice) => {
    return `
  ...
  * {
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
        ...
        <img align="center" border="0" src="images/image-5.png" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 178px;" width="178"/>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
        ...
        <img align="center" border="0" src="images/image-4.png" alt="Hero Image" title="Hero Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" width="600"/>
  ...
  <table id="u_content_text_87" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 14px; color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><strong><span style="font-family: Montserrat, sans-serif; line-height: 22.4px; font-size: 16px;">${user.name}</span></strong></span></p>
    </div>
  ...
  <table id="u_content_text_88" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 14px; color: #34495e; line-height: 150%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 150%;"><span style="font-family: Lato, sans-serif; font-size: 14px; line-height: 21px;"><span style="font-size: 16px; line-height: 24px;">&nbsp;Thank you for shopping with [Your E-commerce Website]! We're delighted to provide you with your invoice for Order #[Order Number]. Below, you'll find a breakdown of your purchases:

      <strong><span style="color: #e67e23; font-size: 16px; line-height: 24px;"> <span style="font-size: 18px; line-height: 27px;">invoice #10237</span></span></strong>, which we sent on March 25th, will be due next week.</span></span></p>
    </div>
  ...
  <table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px; font-family: Montserrat, sans-serif;">123-456-7890</span></p>
    </div>
  ...
  <table id="u_content_text_7" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px; font-family: Montserrat, sans-serif;">your@mail.com</span></p>
    </div>
  ...
  <table id="u_content_text_6" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px; font-family: Montserrat, sans-serif;">yourwebsite.com </span></p>
    </div>
  ...
  <table id="u_content_text_5" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px; font-family: Montserrat, sans-serif;">San Francisco, CA. United States </span></p>
    </div>
  ...
  <table id="u_content_text_19" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;">10237</span></p>
    </div>
...
var instance = new razorpay_1.default({
    key_id: "rzp_test_nygA3vR5xQffUJ",
    key_secret: "7XWnFM3iB3hdN7IJHlKbgu0e",
});
exports.createOrder = (0, catchAsyncError_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
        (_a = user.orders) === null || _a === void 0 ? void 0 : _a.push(order._id);
        user.save();
    }
    res
        .status(201)
...
const order = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const orderID = yield instance.orders.create(options, function (err, order) {
        console.log(order);
    });
    if (!exports.order) {
        return next(new ErrorHandler_1.default(`Payment failed`, 404));
    }
});
exports.order = order;
exports.ValidateOrder = (0, catchAsyncError_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { razorpay_order_id, razorpay_payment_id, razorpay_signature } = req.body;
        const sha = crypto_1.default.createHmac("sha256", "7XWnFM3iB3hdN7IJHlKbgu0e");
        ...
        console.log(err, "error in payment validation");
        next(err);
    }
}));
